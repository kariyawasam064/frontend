    ...
    <GlassLayout maxWidth="xl" backgroundGradient="135deg, rgba(65, 105, 225, 0.7), rgba(219, 112, 147, 0.8)">
      <Box sx={{ position: 'relative', zIndex: 2, marginTop: '60px' }}>
        <div className="post-content-wrapper" style={{
          ...
          {/* Template preview container with selection functionality */}
          <div className="select-template-section" style={{
            ...
            <div className="template-preview-container">
              {/* Template 1 */}
              <div 
                className={`template template-1 ${templateID === 1 ? 'selected-template' : ''}`}
                onClick={() => setTemplateID(1)}
                style={{
                  cursor: 'pointer',
                  position: 'relative',
                  transition: 'transform 0.2s, box-shadow 0.3s',
                  border: templateID === 1 ? '3px solid #4CAF50' : '1px solid #ddd',
                  boxShadow: templateID === 1 ? '0 0 15px rgba(76, 175, 80, 0.5)' : '0 4px 8px rgba(0, 0, 0, 0.1)'
                }}
              >
                ...
                {(imagePreview || existingImage) && <div className="image-preview-indicator">Image</div>}
                {contentURL && <div className="video-preview-indicator">Video</div>}
              ...
              {/* Template 2 */}
              <div 
                className={`template template-2 ${templateID === 2 ? 'selected-template' : ''}`}
                onClick={() => setTemplateID(2)}
                style={{
                  cursor: 'pointer',
                  position: 'relative',
                  transition: 'transform 0.2s, box-shadow 0.3s',
                  border: templateID === 2 ? '3px solid #4CAF50' : '1px solid #ddd',
                  boxShadow: templateID === 2 ? '0 0 15px rgba(76, 175, 80, 0.5)' : '0 4px 8px rgba(0, 0, 0, 0.1)'
                }}
              >
              ...
              {/* Template 3 */}
              <div 
                className={`template template-3 ${templateID === 3 ? 'selected-template' : ''}`}
                onClick={() => setTemplateID(3)}
                style={{
                  cursor: 'pointer',
                  position: 'relative',
                  transition: 'transform 0.2s, box-shadow 0.3s',
                  border: templateID === 3 ? '3px solid #4CAF50' : '1px solid #ddd',
                  boxShadow: templateID === 3 ? '0 0 15px rgba(76, 175, 80, 0.5)' : '0 4px 8px rgba(0, 0, 0, 0.1)'
                }}
              >
            ...
            <p style={{ 
              ...
              marginTop: '15px', 
              fontWeight: 'bold',
              color: templateID ? '#4CAF50' : '#FF6F61' 
            }}>
              {templateID ? `Template ${templateID} selected` : 'Click on a template to select it'}
            </p>
          </div>
